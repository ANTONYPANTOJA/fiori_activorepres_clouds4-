		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Reporte Resumido Inflación para cuentas de mayor",
									"targetURL": "#nsasazappreportinflacionres-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsasazappreportinflacionres-display": {
								"semanticObject": "nsasazappreportinflacionres",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.asa.zappreportinflacionres",
									"url": sap.ui.require.toUrl("ns/asa/zappreportinflacionres")
								}
							}
						}
					}
